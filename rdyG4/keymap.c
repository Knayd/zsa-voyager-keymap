...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  [0] = LAYOUT_voyager(
    ...
    OSM(MOD_LCTL),  LT(4, KC_Z),    KC_X,           KC_C,           KC_V,           KC_B,                                           KC_N,           KC_M,           KC_COMMA,       KC_DOT,         KC_SLASH,       KC_LEFT_SHIFT,  
                                                    MO(1),          OSM(MOD_LSFT),                                  LT(3, KC_ENTER),LT(2, KC_SPACE)
  ),
  [1] = LAYOUT_voyager(
...
const uint16_t PROGMEM combo2[] = { OSM(MOD_LSFT), LT(3, KC_ENTER), COMBO_END};
